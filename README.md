# Eschaton Genesis Translation Project

## Link to the latest nightly translation

Download from [HERE](https://github.com/ftl-mv-translation/Eschaton-Genesis/releases/latest). (Updated every UTC 00:00)
...
1. Unzip the latest EG into src-en/ directory
